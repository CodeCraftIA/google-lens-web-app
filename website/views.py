        ...
        try:
            if (not uses_our_key) or (current_user.api_key_uses > 0):
                if not current_user.is_authenticated:
                    flash('You need to login or register to upload and process images.', category='error')
